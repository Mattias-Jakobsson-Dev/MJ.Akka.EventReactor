...
[PublicAPI]
public static class EventSourcedEventReactorTransformWithExtensions
{
    public static ISetupEventSourcedEventReactorFor<TEvent, TState> TransformWith<TEvent, TState>(
